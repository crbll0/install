...
sudo apt-get install git python3 python3-pip build-essential wget python3-dev python3-venv python3-wheel libxml2-dev libxslt-dev libzip-dev libldap2-dev libsasl2-dev libssl-dev python3-setuptools node-less libpng12-0 gdebi nginx -y
...
sudo su $OE_USER -c "mkdir $OE_HOME/custom/grow_modules"
